...
public class CommonsInstanceDiscovery implements InstanceDiscovery {
    ...
    protected List<String> getApplications() {
        ...
        if(appConfigList!=null && appConfigList.size()==1 && "_all_".equalsIgnoreCase(appConfigList.get(0))){
            //当turbine.app-config=_all_时，表示监控全部服务
            List<String> appNameList = new ArrayList<>();
            EurekaClient eurekaClient = ApplicationContextProvider.getBean("eurekaClient");
